...
VK_CTS_REFERENCE="${FPR_PIGLIT_REPORTS_PATH}/reference/${FPR_VK_CTS_PREFIX}${FPR_VK_CTS_REFERENCE_SUFFIX:+-}${FPR_VK_CTS_REFERENCE_SUFFIX}"
GL_CTS_REFERENCE="${FPR_PIGLIT_REPORTS_PATH}/reference/${FPR_GL_CTS_PREFIX}${FPR_GL_CTS_REFERENCE_SUFFIX:+-}${FPR_GL_CTS_REFERENCE_SUFFIX}"
DEQP_GLES2_REFERENCE="${FPR_PIGLIT_REPORTS_PATH}/reference/${FPR_DEQP_GLES2_PREFIX}${FPR_DEQP_GLES2_REFERENCE_SUFFIX:+-}${FPR_DEQP_GLES2_REFERENCE_SUFFIX}"
DEQP_GLES3_REFERENCE="${FPR_PIGLIT_REPORTS_PATH}/reference/${FPR_DEQP_GLES3_PREFIX}${FPR_DEQP_GLES3_REFERENCE_SUFFIX:+-}${FPR_DEQP_GLES3_REFERENCE_SUFFIX}"
DEQP_GLES31_REFERENCE="${FPR_PIGLIT_REPORTS_PATH}/reference/${FPR_DEQP_GLES31_PREFIX}${FPR_DEQP_GLES31_REFERENCE_SUFFIX:+-}${FPR_DEQP_GLES31_REFERENCE_SUFFIX}"
PIGLIT_REFERENCE="${FPR_PIGLIT_REPORTS_PATH}/reference/${FPR_PIGLIT_PREFIX}${FPR_PIGLIT_REFERENCE_SUFFIX:+-}${FPR_PIGLIT_REFERENCE_SUFFIX}"
